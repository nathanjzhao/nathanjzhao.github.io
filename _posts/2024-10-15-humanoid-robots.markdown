...
<!-- - let's address concerns that any humanoid could simply be replaced with a dishwasher, a roomba, etc. These comments are often reminiscent of David Letterman's interview with Bill Gates (here https://www.youtube.com/watch?v=fs-YpQj88ew, at the 3:10 marker) -- in such, david letterman talks about how the internet could be easily replaced with radio, magazines, and so on. robots will gain traction for much of the same reason --- we don't want many things to solve many problems. we want one solution, so we have minimal solution-problem pairings which result in brain lag throughout our lives. it's easier to gain consumer support with a single solution than having to sell them on each new device or service. additionally, like with the internet, there will likely be more emergent benefits with their integration into our lives. we simply cannot imagine it yet, because we do not have the same technology. Robots Replace function-specific devices, Not the Other Way Around


- another problem is that some critics do not find consumer robotics or robots in households very appealing either --- they think robots are meant just for industrial environments. robots are too expensive, difficult to operate, and so on. Only meant for the rich or the technical. however, this argument begins to sound like the one against home computers, which had their own share of initial skepticism
  - Commodore Magazine, September 1987 "There is a general feeling that the home computer was a fad and that there is really no practical purpose for a computer in the home."
  - In the New York Magazine 1979, "What can you do with it once you have got it? Well, uh, you can do your taxes on it. But it’s easier to hire an accountant. You could balance your checkbook with it. But that’s a little like killing a fly with a cannon. You could play games with it. But there are video Pong sets now that sell for $25."
the truth is, prices will reduce over time, as with all of technology. thus, this is not a valid worry. -->
...
<!-- Open-source development addresses this problem. By moving towards an open-source model, the industry can create a shared knowledge pool, enabling companies to build on each other’s work rather than reinventing the same systems repeatedly. With a collective knowledge base, progress becomes universal across companies, allowing them to focus on genuine innovation instead of re-solving foundational problems. Open source not only combines expertise and minimizes duplication but also accelerates advancements in humanoid robotics, creating an environment where companies can collaboratively push toward consumer-ready robots that no single proprietary approach has yet achieved. -->
